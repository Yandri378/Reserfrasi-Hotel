        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Tambah Reservasi Baru</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('reservasi.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_tamu') is-invalid @enderror" 
                                       id="nama_tamu" name="nama_tamu" value="{{ old('nama_tamu') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('jumlah_tamu') is-invalid @enderror" 
                                       id="jumlah_tamu" name="jumlah_tamu" value="{{ old('jumlah_tamu', 1) }}" min="1" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="hidden" id="harga_per_malam" name="harga_per_malam" value="{{ old('harga_per_malam') }}">
                            </div>
                        </div>
